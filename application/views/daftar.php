...
<body class="bg-gradient-warning">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg m-card">
                            ...
                            <form class="user" action="<?=base_url()?>auth/daftar" method="post">
                                ...
                                <div class="form-group">
                                    <input type="tel" class="form-control form-control-user" 
                                        placeholder="Nomor HP/Telp" name="telp" required>
                                </div>
                                <div class="form-group">
                                    <textarea name="alamat" id="" class="form-control form-control-user"
                                        placeholder="Alamat" required></textarea>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Buat Kata Sandi" name="password"
                                            required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Masukkan Lagi Kata Sandi"
